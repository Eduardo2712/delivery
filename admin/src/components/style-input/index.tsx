...
const StyleInput = ({ handleChange, handleBlur, name, type = "text", title, errors, touched, value, is_required, max_length = undefined }: Props) => {
    return (
        <>
            ...
            <input
                className="bg-slate-700 block w-full rounded-md border-0 py-2 px-2 text-gray-100 shadow-sm ring-1 ring-gray-800 placeholder:text-gray-400 focus:ring-blue-500 sm:text-sm sm:leading-6"
                id={name}
                type={type}
                name={name}
